...
[step5_magentic_one](../getting_started_with_agents/multi_agent_orchestration/step5_magentic_one.py)|How to run agents in a Magentic One orchestration to complete a task.
