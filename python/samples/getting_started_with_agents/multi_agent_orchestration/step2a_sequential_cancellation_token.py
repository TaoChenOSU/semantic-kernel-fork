...
logging.getLogger("semantic_kernel.agents.orchestration.sequential").setLevel(
    logging.DEBUG
)  # Enable DEBUG for sequential pattern
...
async def main():
    ...
    # Simulate some delay before cancellation
    await asyncio.sleep(1)
    # Cancel the orchestration
    orchestration_result.cancel()

    try:
        # Attempt to get the result, which should raise an exception due to cancellation
